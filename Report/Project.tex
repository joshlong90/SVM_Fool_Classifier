...
\begin{itemize}
  ...
  \item{For each example in test\_data.txt, find the 10 most important class 1 words and replace them with the 10 most important class 0 words that are not already present. If the example does not contain 10 class 1 words, add extra words to total 20 changes.}
\end{itemize}
